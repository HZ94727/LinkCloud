...
| status        | tinyint  | -    | 是     | 1                 | 访问短链接状态，1表示成功，2表示失败 |
...
| status                | int32  | 否   | -          | **不传**查所有，**传1**查启用，**传0**查禁用 |
...
| status       | int32      | 短链接状态，1表示启用，0表示禁用      |
